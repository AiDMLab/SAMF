library(survival)
library(survminer)
clusterFile="ICIcluster2_SNF_Lung_NEW.txt"          #code7：SNF算法生成的免疫聚类文件
clusterFile="ICIcluster2_SNF_Lung.txt"              #code7；肺癌数据生成的免疫聚类文件
cliFile="clinical.csv"               #生存数据文件
setwd("D:\\data\\7_compare")      #设置工作目录
...
pdf(file="survival_SNF.pdf",onefile = FALSE, #file="survival_Lung.pdf"或file="survival_SNF.pdf"
    width = 5.5,             #图片的宽度
    height =5)             #图片的高度
ggsurvplot(fit, 
           data=rt,
